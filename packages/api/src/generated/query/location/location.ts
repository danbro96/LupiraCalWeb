 ...
 */
export const ingestLocation = async (ingestLocationBody: string, options?: Parameters<typeof apiRequest>[1]): Promise<LocationIngestReceipt> => {
...
return apiRequest<LocationIngestReceipt>(getIngestLocationUrl(),
  {
    ...options,
    method: 'POST',
 ...
 */
export const getIngestCursor = async ( options?: Parameters<typeof apiRequest>[1]): Promise<LocationCursor> => {

  return apiRequest<LocationCursor>(getGetIngestCursorUrl(),
  {
    ...options,
    method: 'GET'
...
export const getGetIngestCursorQueryKey = () => {
    return [
    `/location-api/ingest/location/cursor`
    ] as const;
    }
 ...
 */
export const getIngestState = async ( options?: Parameters<typeof apiRequest>[1]): Promise<TrackingStateDto> => {

  return apiRequest<TrackingStateDto>(getGetIngestStateUrl(),
  {
    ...options,
    method: 'GET'
...
export const getGetIngestStateQueryKey = () => {
    return [
    `/location-api/ingest/location/state`
    ] as const;
    }
