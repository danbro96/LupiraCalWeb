 ...
 */
export const commsPing = async ( options?: Parameters<typeof apiRequest>[1]): Promise<PingDto> => {

  return apiRequest<PingDto>(getCommsPingUrl(),
  {
    ...options,
    method: 'GET'
...
export const getCommsPingQueryKey = () => {
    return [
    `/comms-api/pingz`
    ] as const;
    }
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getCommsPingQueryKey();



    const queryFn: QueryFunction<Awaited<ReturnType<typeof commsPing>>> = ({ signal }) => commsPing({ signal, ...requestOptions });
 ...
 */
export const ingestMessages = async (ingestMessageRequest: IngestMessageRequest, options?: Parameters<typeof apiRequest>[1]): Promise<IngestAcceptedResponse> => {
...
return apiRequest<IngestAcceptedResponse>(getIngestMessagesUrl(),
  {
    ...options,
    method: 'POST',
...
export const getIngestMessagesMutationOptions = <TError = ProblemDetails,
...
): UseMutationOptions<Awaited<ReturnType<typeof ingestMessages>>, TError,{data: IngestMessageRequest}, TContext> => {

const mutationKey = ['ingestMessages'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof ingestMessages>>, {data: IngestMessageRequest}> = (props) => {
          const {data} = props ?? {};

          return  ingestMessages(data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type IngestMessagesMutationResult = NonNullable<Awaited<ReturnType<typeof ingestMessages>>>
    export type IngestMessagesMutationBody = IngestMessageRequest
    export type IngestMessagesMutationError = ProblemDetails
 ...
 */
export const listArcs = async (params?: ListArcsParams, options?: Parameters<typeof apiRequest>[1]): Promise<ArcSummaryDto[]> => {

  return apiRequest<ArcSummaryDto[]>(getListArcsUrl(params),
  {
    ...options,
    method: 'GET'
...
export const getListArcsQueryKey = (params?: ListArcsParams,) => {
    return [
    `/comms-api/arcs`, ...(params ? [params] : [])
    ] as const;
    }
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getListArcsQueryKey(params);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof listArcs>>> = ({ signal }) => listArcs(params, { signal, ...requestOptions });
...
export const getArc = async (id: string,
    params?: GetArcParams, options?: Parameters<typeof apiRequest>[1]): Promise<ArcDetailDto> => {

  return apiRequest<ArcDetailDto>(getGetArcUrl(id,params),
  {
    ...options,
    method: 'GET'
...
export const getGetArcQueryKey = (id: string,
    params?: GetArcParams,) => {
    return [
    `/comms-api/arcs/${id}`, ...(params ? [params] : [])
    ] as const;
    }
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetArcQueryKey(id,params);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getArc>>> = ({ signal }) => getArc(id,params, { signal, ...requestOptions });
