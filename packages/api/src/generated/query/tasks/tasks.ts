 ...
 */
export const tasksPing = async ( options?: Parameters<typeof apiRequest>[1]): Promise<PingDto> => {

  return apiRequest<PingDto>(getTasksPingUrl(),
  {
    ...options,
    method: 'GET'
...
export const getTasksPingQueryKey = () => {
    return [
    `/tasks-api/pingz`
    ] as const;
    }
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getTasksPingQueryKey();



    const queryFn: QueryFunction<Awaited<ReturnType<typeof tasksPing>>> = ({ signal }) => tasksPing({ signal, ...requestOptions });
 ...
 */
export const getUserDirectory = async (params?: GetUserDirectoryParams, options?: Parameters<typeof apiRequest>[1]): Promise<DirectoryResponse> => {

  return apiRequest<DirectoryResponse>(getGetUserDirectoryUrl(params),
  {
    ...options,
    method: 'GET'
...
export const getGetUserDirectoryQueryKey = (params?: GetUserDirectoryParams,) => {
    return [
    `/tasks-api/users/directory`, ...(params ? [params] : [])
    ] as const;
    }
 ...
 */
export const getSharedList = async (token: string, options?: Parameters<typeof apiRequest>[1]): Promise<SharedListResponse> => {

  return apiRequest<SharedListResponse>(getGetSharedListUrl(token),
  {
    ...options,
    method: 'GET'
...
export const createSharedItem = async (token: string,
    createItemRequest: CreateItemRequest, options?: Parameters<typeof apiRequest>[1]): Promise<SharedItemDto> => {
...
return apiRequest<SharedItemDto>(getCreateSharedItemUrl(token),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...getHeaders(options?.headers) },
...
return apiRequest<SharedItemDto>(getUpdateSharedItemUrl(token,itemId),
  {
    ...options,
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...getHeaders(options?.headers) },
...
export const deleteSharedItem = async (token: string,
  ...
  return apiRequest<void>(getDeleteSharedItemUrl(token,itemId,params),
  {
    ...options,
    method: 'DELETE'
...
return apiRequest<SharedItemDto>(getCompleteSharedItemUrl(token,itemId),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...getHeaders(options?.headers) },
...
return apiRequest<SharedItemDto>(getReopenSharedItemUrl(token,itemId),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...getHeaders(options?.headers) },
...
return apiRequest<SharedItemDto>(getMoveSharedItemUrl(token,itemId),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...getHeaders(options?.headers) },
