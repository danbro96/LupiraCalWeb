...
// Dynamic lookups only: the tokens package names concepts, this resolves them. Exhaustive over
// IconName, so adding a name in tokens fails the build here rather than rendering nothing.
export { default as CleaningIcon } from '@mui/icons-material/CleaningServicesOutlined';
...
export { default as MedicalIcon } from '@mui/icons-material/MedicalServicesOutlined';
export { default as RestaurantIcon } from '@mui/icons-material/RestaurantOutlined';
export { default as RobotIcon } from '@mui/icons-material/SmartToyOutlined';
export { default as RunIcon } from '@mui/icons-material/DirectionsRunOutlined';
export { default as ScheduleIcon } from '@mui/icons-material/ScheduleOutlined';
export { default as TargetIcon } from '@mui/icons-material/TrackChangesOutlined';
export { default as ToolsIcon } from '@mui/icons-material/ConstructionOutlined';
export { default as WalkIcon } from '@mui/icons-material/DirectionsWalkOutlined';
