...
/// lupira-cal + lupira-contact + lupira-geo + lupira-tasks via the -aud scope mappings, so one bearer
/// satisfies the BFF and every upstream it proxies. Refresh grants never widen scopes — adding an
/// audience here only takes effect after a sign-out/in.
