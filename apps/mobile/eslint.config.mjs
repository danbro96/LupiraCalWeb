    ...
    rules: {
      'boundaries/dependencies': ['error', {
        ...
        policies: [
          ...
          { from: { element: { type: 'data' } }, allow: to('data', 'domain', 'generated', 'debug', 'config') },
          { from: { element: { type: 'sync' } }, allow: to('sync', 'data', 'domain', 'generated', 'debug', 'config') },
          { from: { element: { type: 'state' } }, allow: to('state', 'sync', 'data', 'domain', 'generated', 'debug', 'config') },
          { from: { element: { type: 'ui' } }, allow: to('ui', 'state', 'sync', 'data', 'domain', 'generated', 'debug', 'config') },
